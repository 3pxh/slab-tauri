    ...
    <div className="w-full max-w-md mx-auto p-4">
      ...
      <div className="prose prose-sm max-w-none">
        <div className="text-gray-800 leading-relaxed">
          ...
          <p className="mt-6 text-sm text-gray-600 italic">
          PPS this app is given freely and licensed in the public domain via CC0. You are free to remix, distribute, and otherwise make it your own as you like. Visit the <a href="https://source.slab17.com" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:text-blue-900 underline font-medium">source.slab17.com</a> for the source code.
          </p>
        </div>
      </div>
    </div>
